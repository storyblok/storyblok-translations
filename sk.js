export default {
  "Dashboard": "Prehľad",
  "Back to spaces": "Späť do projektov",
  "Content": "Obsah",
  "Commerce": "Obchod",
  "Assets": "Dokumenty/Súbory",
  "Datasources": "Číselník",
  "Activities": "Aktivity",
  "Tasks": "Úlohy",
  ...
  "Plugins": "Pluginy",
  "Logout": "Odhlásiť",
  "Report a problem": "Nahlásiť chybu/problém",
  "Create new space": "Vytvoriť nový projekt",
  "Search spaces...": "Nájsť projekt...",
  "My organization": "Moja organizácia",
  "Subscribe": "Predplatiť",
  "To": "Od",
  "From": "Do",
  "Apply filter": "Filter aplikovať",
  "Filter": "Filter",
  ...
  "Open": "Otvoriť",
  "Restore this Story": "Obnoviť tento element",
  "Categories": "Kategórie",
  "Story": "Element",
  "The item has been restored!": "Tento element bol obnovený!",
  "All": "Všetko",
  "My Apps": "Moje aplikácie",
  "Search for apps, discover new field types and add functionalities to your Storyblok project.": "Suche nach Applikationen, entdecke neue Feldtypen und füge neue Funktionen zu deinem Storyblokprojekt hinzu.", // TODO
  "My apps": "Moje aplikácie",
  "Create new app": "Vytvoriť novú aplikáciu",
  "Installed": "Inštalovať",
  "App Directory": "Applikationsverzeichnis", // TODO
  "There are no apps in this category.": "Nenašli sa žiadne aplikácie v tomto priečinku.",
  "Install": "Inštalovať",
  "Choose the space to install this app": "Zvoľte si projekt kam bude táto aplikácia nainštalovaná.",
  "Can not move asset folder into folder without permissions.": "Priečinok nie je možné presunúť bez príslušných práv.",
  "Can not move asset into folder without permissions.": "Dokumenty nie je možné presunúť do priečínka bez príslušných práv.",
  "Can not move asset away from folder without permissions.": "Dokumentý nie je možné odstrániť z priečnika bez príslušných práv.",
  "Define the new name of the folder.": "Definujte nové meno priečinka.",
  "Trashbin": "Kôš",
  "Are you sure that you want to delete this folder?": "Ste si istý, že chcete zmazať tento priečinok.",
  "Add": "Vložiť",
  "Asset folders are not included in the free plan but you can try them in the": "Priečniky pre dokumenty nie sú dostupné v bezplatnom pláne, ale môžete ich vyskúšať.",
  "New folder will be created in": "Nový priečinok bude vytvorený v",
  "trial period": "skúšobné obdobie",
  "Can not create asset folder without permission for parent.": "Nie je možné vytvoriť priečinok v priečinku, pre ktorý nemáte práva na editáciu.",
  "Updated successfully! Notice: It can take some time until the cache getting cleared.": "Úspešné zmenené! Poznámka: Zmena sa može prejaviť až po nejakom čase, keď bude prepísaná cache pamäť.",
  "Original": "Originál",
  "Done": "Vybavené",
  "Cancel": "Zrušiť",
  "Insert": "Vloťiť",
  "Add Asset(s)": "Vložiť súbor",
  "Close": "Zatvoriť",
  "items": "element",
  "Delete": "Zmazať",
  "Move to folder": "Presunúť do priečinka",
  "Replace": "Nahradiť",
  "Unselect all": "Odznačiť",
  "Restore": "Obnoviť",
  "Tiles": "Kachličky", // TODO context?
  "List": "zoznam",
  "No assets found": "Neboli nájdené žiadne súbory",
  "Sort": "Zoradiť",
  "Default": "Štandarné",
  "View": "Náhľad",
  "Creation date (asc)": "Dátum vytvorenia (aufsteigend)", // todo
  "Filename (asc)": "Meno súboru (aufsteigend)", // todo
  "Creation date (desc)": "Dátum vytvorenia (absteigend)", // todo
  "Filename (desc)": "Meno súboru (absteigend)", // todo
  "Last updated date (asc)": "Dátum poslednej aktualizácie (aufsteigend)", // todo
  "Last updated date (desc)": "Dátum poslednej aktualizácie (absteigend)",
  "You are not allowed to insert this filetype here.": "Nie je sem povolené vložiť tento typ súboru.",
  "This key is already defined": "Tento identifikátor je už použitý.",
  "Key is in invalid format": "Identifikátor je v nepovolenom formáte.",
  "Something went wrong uploading some items": "Nepodarilo sa nahrad súbory.",
  ...
  "In fieldtypes you can use this.api to get access to the Storyblok delivery api. You can use it for example to build a selectbox of stories.": "In den Feldtypen kannst du this.api benutzen um auf die Ausleferungs-API zuzugreifen. Du kannst es z.B. benutzen um eine Selectbox für Stories zu bauen.",
  ...
  "Attention! Transfering the ownership will remove all your rights to this space.": "Achtung! Du wirst keine Rechte mehr haben in diesem Space wenn du die Eigentümerschaft überträgst.",
  ...
  "Transfering was not successfull. Make sure that the new owner exists.": "Übertraung war nicht erfolgreich. Stelle sicher, dass der neue Eigentümer existiert.",
  "The collaborator has been added": "Der Kollaborateur wurde hinzugefügt",
  "Please insert a email": "Bitte füge eine E-Mail ein.",
  ...
  "Skip this steps": "Diesen Schritt überspringen",
  "Move": "Verschieben",
  ...
  "Manage": "Verwalten",
  "Toggle assitance mode": "Zu Betreuungsmodus umschalten",
  ...
  "You will get notified per email once the admin added you as a collaborator. Click then on the button bellow to continue.": "Du wirst per E-Mail benachrichtigt werden wenn der Administrator dich als Kollaborateur hinzugefügt hat. Klicke dann auf die Schaltfläche um fortzufahren.",
