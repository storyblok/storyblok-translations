export default {
  ...
  "Do you really want to copy the content of the default language to the current and replace the existing field value?": "Weet je zeker dat je de content van de huidige taal wilt vervangen met de standaardtaal?",
