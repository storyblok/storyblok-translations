export default {
  ...
  "Examples for field types are colorpickers, WYSYWYG editors or meta tags.": "Voorbeelden van veldtypen zijn colorpickers, WYSIWYG editors of meta tags.",
  ...
  "In fieldtypes you can use this.api to get access to the Storyblok delivery api. You can use it for example to build a selectbox of stories.": "In veldtypen kun je \"this.api\" gebruiken om toegang te krijgen tot de Storyblok API. Je kunt het bijvoorbeeld gebruiken om een dropdown menu met stories te genereren.",
  ...
  "Transfer": "Overdragen",
  "Attention! Transfering the ownership will remove all your rights to this space.": "Let op! Je verliest alle rechten voor deze Space als je het eigendom overdraagt.",
  ...
  "Transfering was not successfull. Make sure that the new owner exists.": "Overdracht mislukt. Zorg ervoor dat de nieuwe eigenaar bestaat.",
  "The collaborator has been added": "De medewerker is toegevoegd",
  "Please insert a email": "Geef een e-mailadres op",
  ...
  "Skip this steps": "Deze stap overslaan",
  "Move": "Verplaatsen",
  "Next steps": "Volgende stap",
  ...
  "Manage": "Beheren",
  "Toggle assitance mode": "Hulpmodus in-/uitschakelen",
  ...
  "You will get notified per email once the admin added you as a collaborator. Click then on the button bellow to continue.": "Je wordt per e-mail op de hoogte gebracht als de beheerder je heeft toegevoegd als medewerker. Klik vervolgens op deze knop om door te gaan.",
