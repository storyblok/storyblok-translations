export default {
  ...
  "Connect your Stripe account to receive your revenue share each month.": "Подключите свою учетную запись Stripe, чтобы видеть свою долю дохода каждый месяц.",
  "Partner details": "Детали партнера",
  "Define your business address and company information. * Required fields": "Определите свой служебный адрес и информацию о компании. * Обязательные поля",
  "Billing email address": "Платежный email адрес",
  "VAT number": "Номер НДС",
  "Company number": "Номер компании",
  "Bank information (for revenue share of enterprise plans)": "Банковская информация (для доли дохода в планах предприятия)",
  "Plan": "Тариф",
  "My spaces": "Мои области",
  "Field-types": "Типы полей",
  "Partner Agreement": "Партнерское соглашение",
  "Current story object": "Текущий объект истории",
  "Partner portal": "Партнерский портал",
  "Show all": "Показать все",
  "Show favorites only": "Показать только любимые",
  "User ID": "Идентификатор пользователя",
  "Single role": "Одиночная роль",
  "Multiple roles": "Несколько ролей",
  "Individual permissions": "Индивидуальные разрешения",
  "Organization": "Организация",
  "Maintenance mode (When enabled only admins can edit content)": "Режим обслуживания (при включении только администраторы могут редактировать контент)",
  "Storage": "Хранилище",
  "Store on the Storyblok S3 bucket": "Хранить на Storyblok S3 bucket",
  "If unchecked the backup will be stored on your own S3 backup.": "Если не выбрано резервные копии будут храниться на вашем S3.",
  "Preferred backup time": "Предпочтительное время резервного копирования",
  "AWS Role ARN": "AWS ARN роли",
  "\"Restore now\" creates a new space with the restore date in the space name.": "\"Восстановить сейчас\" создает новую область с датой восстановления в имени области.",
  "Your Unique Subdomain": "Ваш уникальный поддомен",
  "Your unique subdomain for your rendering service project with Storyblok. Replace this with your \"Location (default environment)\" to get started.": "Ваш уникальный поддомен для вашего проекта по оказанию услуг с Storyblok. Замените это на ваше \"Местоположение (по умолчанию)\" чтобы начать.",
  "Publish translations individually (Beta)": "Публиковать переводы индивидуально (бета)",
  "ATTENTION! When enabling, all languages needs to be published by going to each content item, selecting the language and clicking the Publish button.": "ВНИМАНИЕ! При включении необходимо публиковать все языки, перейдя к каждому элементу контента, выбрать язык и нажать кнопку «Опубликовать».",
  "Beta version: Does not work yet together with releases and duplicating content.": "Бета-версия: пока не работает вместе с версиями и дублированием контента.",
  "I have a developer": "У меня есть разработчик",
  "I am a developer": "Я разработчик",
  "I want to talk": "Хочу пообщаться",
  "Thanks!": "Спасибо!",
  "We received your request!": "Мы получили ваш запрос!",
  "Invites sent!": "Приглашение отправлено!",
  "The invites got sent successfully.": "Приглашения отправлены.",
  "Invite your developer(s) to Storyblok so that they can create a project for you.": "Пригласите своих разработчиков в Storyblok, чтобы они могли создать проект для вас.",
  "Email addresses": "Email адреса",
  "Send invites": "Отправить приглашения",
  "I need a developer": "Мне нужен разработчик",
  "Inform us your project requirements to get offers from developers of our partner network.": "Сообщите нам свои требования к проекту, чтобы получать предложения от разработчиков нашей партнерской сети.",
  "I want to...": "Мне нужно...",
  "migrate a website or app to Storyblok": "перенести сайт или приложение на Storyblok",
  "create a new website or app": "создать сайт или приложение",
  "make an existing website or app editable in Storyblok": "сделать текущий сайт или приложение редактируемым через Storyblok",
  "Budget": "Бюджет",
  "Less than $ 2.000": "Менее $ 2.000",
  "$ 2.000 to 5.000": "$ от 2.000 до 5.000",
  "$ 5.000 to 20.000": "$ от 5.000 до 20.000",
  "More than $ 20.000": "Более $ 20.000",
  "Project details": "Детали проекта",
  "Switch to a developer account to create spaces for development of websites and apps. You can switch back to a content editor account in the my account section ": "Переключитесь на учетную запись разработчика, чтобы создать пространство для разработки веб-сайтов и приложений. Позже вы можете вернуться к учетной записи редактора контента в разделе «Моя учетная запись».",
  "Switch": "Переключиться",
  "Get in touch with someone at the Storyblok team to get a demo or discuss your requirements.": "Свяжитесь с кем-то из команды Storyblok, чтобы получить демо или обсудить ваши требования.",
  "Company name": "Имя компании",
  "Message": "Сообщение",
  "Send message": "Отправить сообщение",
  "Do you want to assign the space to your organization?": "Вы хотите привязать область к организации?",
  "No (for private spaces)": "Нет (для личных областей)",
  "Allow managing tags": "Разрешить управление тегами",
  "Allow editing datasource keys": "Разрешить управление ключами источников данных",
  "Deny access to image editor": "Запретить доступ к редактору изображений",
  "Force user to create release": "Заставить пользователя создать релиз",
  "Hide content if unauthorized": "Скрыть контент, если он не авторизован",
  "Hide folders if unauthorized": "Скрыть папки, если они не авторизованы",
  "Add branches the user should have the right to deploy to (acts as whitelist). If no item is selected the user has rights to deploy to all branches.": "Добавить ветки, на которые пользователь должен иметь право развертываться (действует как белый список). Если элемент не выбран, у пользователя есть права на развертывание во всех ветках.",
  "Component/content-type permissions": "Разрешения по компонентам/типам контента",
  "Add the components or content types the user should not be able to select (acts as blacklist).": "Добавьте компоненты или типы контента, которые пользователь не должен выбирать (действует как черный список).",
  "It seams that you do not have access to any space yet. Please contact the administrator of your organization to get added as a collaborator.": "Похоже, у вас еще нет доступа ни к одной области. Свяжитесь с администратором вашей организации, чтобы он добавил вас как работника.",
  "Start by selecting a space in the sidebar.": "Начните с выбора области в левом меню.",
  "Details": "Детали",
  "Your current plan is ": "Ваш текущий план ",
  "Pressing the button below will cancel your current subscription and remove all collaborators.": "Нажатие на кнопку ниже отменит вашу текущую подписку и удалит всех сотрудников.",
  "Cancel subscription": "Отменить подписку",
  "The starter plan is our free plan, so nothing we can cancel for you. If you are still receiving charges, let us know in our live-chat!": "Стартовый план - это наш бесплатный план, поэтому мы ничего не можем отменить для вас. Если вы все еще получаете оплату, сообщите нам об этом в чате!",
  "We are really sorry to see you go, but would love to understand why.": "Нам очень жаль, что вы ушли и хотелось бы понять почему.",
  "Set following stage after published": "Установить следующий этап после публикации",
  "Attention! There are ": "Внимание! Есть ",
  " reference(s). Click to show.": " исходник(и). Нажмите, чтобы увидеть.",
  "Undo (Ctrl+Z)": "Откатить (Ctrl+Z)",
  "Redo (Ctrl+Y)": "Откатить вперед (Ctrl+Y)",
  "This block is not available any more.": "Этот блок больше не доступен.",
  "Go back to the root": "Вернуться к началу",
  "Please choose a release or create a new one to make your content changes.": "Пожалуйста, выберите релиз или создайте новый, чтобы внести изменения в контент.",
  "First published date (asc)": "Первая дата публикации (по возрастанию)",
  "First published date (desc)": "Первая дата публикации (по убыванию)",
  "Published date (asc)": "Дата публикации (по возрастанию)",
  "Published date (desc)": "Дата публикации (по убыванию)",
  "Tag list": "Список тегов",
  "First published at": "Впервые опубликовано",
  "Translated name": "Переведенное имя",
  "You can create a new tag at the config section of a content item.": "Вы можете создать новый тег в разделе конфигурации элемента.",
  "Assigned items": "Привязанные элементы",
  "User dialog": "Диалог с пользователем",
  "Containing content item": "Контент элемента",
  "Containing asset": "Вложенный ресурс",
  "Clear all filters": "Сбросить все фильтры",
  "Load all": "Загрузить все",
  "The user dialog JSON is invalid.": "JSON диалога с пользователем некорректен.",
  "Edit App": "Редактировать приложение",
  "All apps": "Все приложения",
  "App installed successfully!": "Приложение установлено!",
  "New App": "Новое приложение",
  "App approved successfully": "Приложение успешно утверждено",
  "Your app has been submitted sucessfully.": "Ваше приложение было успешно отправлено.",
  "Please define a name": "Задайте имя",
  "Trashcan cleared!": "Корзина очищена!",
  "Type the domain to move all users with @domain.com to the org with that domain.": "Введите домен, чтобы переместить всех пользователей с @domain.com в организацию с этим доменом.",
  "Define a name for the tab": "Задайте имя вкладки",
  "Are you sure you want to delete this tab?": "вы уверены, что хотите удалить вкладку?",
  "Define the anchor id of the link.": "Укажите идентификатор якоря для ссылки.",
  "is not a valid email": "некорректный email",
  "Are you sure that you want to remove this space from the organization?": "Вы уверены, что хотите удалить эту область из организации?",
  "Space has been removed from organization": "Область удалена из организации",
  "Space added successfully": "Область добавлена",
  "Organization created successfully": "Организация создана",
  "Are you sure you want to remove this language?": "Вы уверены, что хотите удалить этот язык?",
  "Are you sure you want to unsubscribe and remove all collaborators?": "Вы уверены, что хотите отписаться и удалить всех работников?",
  "Please save the schema of this component first.": "Сперва сохраните схему этого компонента.",
  "Character limit reached": "Достигнут лимит символов",
  "characters remaining": "осталось символов",
  "characters over limit": "символов превышают лимит"
}
