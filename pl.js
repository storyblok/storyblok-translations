export default {
  ...
  "Other": "Inne",
  "Business area": "Obszar biznesowy",
  "Accounting": "Księgowość",
  "Marketing and Advertising": "Marketing i reklama",
  "Automotive": "Branża Automotive",
  ...
  "Hospitality": "Biznes hotelarski",
  "Insurance": "Ubezpieczenia",
  "Legal": "Prawny",
  "Manufacturing": "Produkcja",
  "Media": "Media",
  "Oil and Energy": "Paliwo i Energetyka",
  "Pharmaceutical": "Farmaceutyka",
  ...
  "Utility": "Branża Komunalna",
  "* Required fields": "* Wymagane pola",
  "Continue": "Kontynuuj",
  "Personal settings": "Ustawienia osobiste",
  "How would you describe your role?": "Jak opisałbyś swoją rolę?",
  "I am a content editor": "Jestem redaktorem",
  "I am a developer or administrator": "Jestem programistą lub administratorem",
  "Add space to organization": "Dodaj przestrzeń do organizacji",
  "Add space": "Dodaj przestrzeń",
  "Unlink": "Usuń linkowanie",
  "Create your first app": "Stwórz swoją pierwszą aplikację",
  "No invoices found": "Nie znaleziono żadnych faktur",
  "Space": "Przestrzeń",
  "Invoice ID": "ID Faktury",
  "Amount": "Ilość",
  "# of Spaces": "# Przestrzeni",
  "Revenue": "Dochód",
  "MRR": "Miesięczne cykliczne dochody",
  "Nr. of spaces": "Liczba przestrzeni",
  "Active subscriptions": "Aktywne subskrybcje",
  "Total revenue share per month": "Całkowity udział w przychodach miesięcznie",
  "Welcome to the partner portal of Storyblok! We are excited to have you on board!": "Witamy na portalu partnerskim Storyblok! Cieszymy się, że jesteś na pokładzie!",
  "App type": "Typ aplikacji",
  "Sidebar": "Pasek boczny",
  "Fieldtype(s)": "Typ(y) pola",
  "Add an existing space": "Dodaj istniejącą przestrzeń",
  "Member: Can manage spaces and apps": "Członek: Może zarządzać przestrzeniami i aplikacjami",
  "Owner: Can manage users, spaces, apps, partner account settings and see finances": "Właściciel: Może zarządzać użytkownikami, przestrzeniami, aplikacjami, ustawieniami konta partnerskiego oraz ma wgląd w finanse",
  "Stripe connect": "Podłącz Stripe",
  "Connect your Stripe account to receive your revenue share each month.": "Połącz swoje konto Stripe, aby otrzymywać swój udział w przychodach co miesiąc.",
  "Partner details": "Dane partnera",
  "Define your business address and company information. * Required fields": "Określ adres swojej firmy i informacje o niej. * Wymagane pola",
  "Billing email address": "Adres e-mail do fakturowania",
  "VAT number": "Numer VAT",
  "Company number": "Numer firmowy",
  "Bank information (for revenue share of enterprise plans)": "Informacje bankowe (w przypadku udziału w przychodach planów przedsiębiorstw)",
  "Plan": "Plan",
  "My spaces": "Moje przestrzenie",
  "Field-types": "Typy pól",
  "Partner Agreement": "Umowa Partnerska",
  "Current story object": "Bieżący obiekt historii",
  "Partner portal": "Portal Partnerski",
  "Show all": "Pokaż wszystkie",
  "Show favorites only": "Pokaż tylko ulubione",
  "User ID": "ID Użytkownika",
  "Single role": "Jedna rola",
  "Multiple roles": "Wiele ról",
  "Individual permissions": "Uprawnienia indywidualne",
  "Organization": "Organizacja",
  "Maintenance mode (When enabled only admins can edit content)": "Tryb konserwacji (po włączeniu tylko administratorzy mogą edytować zawartość)",
  "Storage": "Przechowywanie",
  "Store on the Storyblok S3 bucket": "Przechowuj na S3-Bucket Storybloka",
  "If unchecked the backup will be stored on your own S3 backup.": "Jeśli odznaczone, kopia zapasowa zostanie zapisana na twojej własnej kopii zapasowej S3.",
  "Preferred backup time": "Preferowany czas tworzenia kopii zapasowej",
  "AWS Role ARN": "Rola AWS ARN",
  "\"Restore now\" creates a new space with the restore date in the space name.": "\"Przywróć teraz\" tworzy nową przestrzeń z nazwą ustawioną na datę przywrócenia.",
  "Your Unique Subdomain": "Twoja Unikatowa Subdomena",
  "Your unique subdomain for your rendering service project with Storyblok. Replace this with your \"Location (default environment)\" to get started.": "Twoja unikatowa subdomena dla projektu usługi renderowania za pomocą Storyblok. Zamień na \"Lokalizacja (środowisko domyślne)\", aby rozpocząć.",
  "Publish translations individually (Beta)": "Publikuj tłumaczenia indywidualnie (Beta)",
  "ATTENTION! When enabling, all languages needs to be published by going to each content item, selecting the language and clicking the Publish button.": "UWAGA! Po włączeniu wszystkie języki muszą zostać opublikowane, przechodząc do każdego elementu treści, wybierając język i klikając przycisk Publikuj.",
  "Beta version: Does not work yet together with releases and duplicating content.": "Wersja beta: Nie działa jeszcze w połączeniu z wydaniami i powielaniem treści.",
  "I have a developer": "Mam programistę",
  "I am a developer": "Jestem programistą",
  "I want to talk": "Chcę porozmawiać",
  "Thanks!": "Dzięki!",
  "We received your request!": "Otrzymaliśmy twoje zapytanie!",
  "Invites sent!": "Zaproszenia wysłane!",
  "The invites got sent successfully.": "Zaproszenia zostały wysłane pomyślnie.",
  "Invite your developer(s) to Storyblok so that they can create a project for you.": "Zaproś programistów do Storyblok, aby mogli stworzyć dla Ciebie projekt.",
  "Email addresses": "Adres email",
  "Send invites": "Wyślij zaproszenia",
  "I need a developer": "Potrzebuję programisty",
  "Inform us your project requirements to get offers from developers of our partner network.": "Poinformuj nas o wymaganiach dotyczących projektu, aby uzyskać oferty od programistów naszej sieci partnerskiej.",
  "I want to...": "Chcę...",
  "migrate a website or app to Storyblok": "zmigrować stronę lub aplikację do Storyblok",
  "create a new website or app": "stworzyć nową stronę lub aplikację",
  "make an existing website or app editable in Storyblok": "sprawić aby istniejąca strona lub aplikacja była edytowalna w Storyblok",
  "Budget": "Budżet",
  "Less than $ 2.000": "Mniej niż 2.000 USD",
  "$ 2.000 to 5.000": "2.000 do 5.000 USD",
  "$ 5.000 to 20.000": "5.000 do 20.000 USD",
  "More than $ 20.000": "Więcej niż 20.000 USD",
  "Project details": "Szczegóły projektu",
  "Switch to a developer account to create spaces for development of websites and apps. You can switch back to a content editor account in the my account section later.": "Przełącz się na konto programisty, aby utworzyć przestrzenie do programowania witryn i aplikacji. Możesz wrócić do konta edytora treści w sekcji moje konto później.",
  "Switch": "Przełącz",
  "Get in touch with someone at the Storyblok team to get a demo or discuss your requirements.": "Skontaktuj się z kimś z zespołu Storyblok, aby uzyskać wersję demonstracyjną lub omówić swoje wymagania.",
  "Company name": "Nazwa firmy",
  "Message": "Wiadomość",
  "Send message": "Prześlij wiadomość",
  "Do you want to assign the space to your organization?": "Czy chcesz przypisać przestrzeń do swojej organizacji?",
  "No (for private spaces)": "Nie (w przypadku przestrzeni prywatnych)",
  "Allow managing tags": "Zezwól na zarządzanie tagami",
  "Allow editing datasource keys": "Zezwól na edytowanie kluczy źródeł danych",
  "Deny access to image editor": "Odmów dostępu do edytora obrazków",
  "Force user to create release": "Zmuś użytkownika do tworzenia wydań",
  "Hide content if unauthorized": "Ukryj treść, jeśli użytkownik jest nieautoryzowany",
  "Hide folders if unauthorized": "Ukryj katalogi, jeśli użytkownik jest nieautoryzowany",
  "Add branches the user should have the right to deploy to (acts as whitelist). If no item is selected the user has rights to deploy to all branches.": "Dodaj gałęzie, które użytkownik powinien mieć prawo wdrożyć (działa jako biała lista). Jeśli żaden element nie zostanie wybrany, użytkownik ma uprawnienia do wdrożenia dla wszystkich gałęzi.",
  "Component/content-type permissions": "Uprawnienia Komponentu/typu treści",
  "Add the components or content types the user should not be able to select (acts as blacklist).": "Dodaj komponenty lub typy treści, których użytkownik nie powinien mieć możliwości wyboru (działa jak czarna lista).",
  "It seams that you do not have access to any space yet. Please contact the administrator of your organization to get added as a collaborator.": "Wygląda na to, że nie masz jeszcze dostępu do żadnej przestrzeni. Skontaktuj się z administratorem swojej organizacji i poproś o dodanie Cie jako współpracownika",
  "Start by selecting a space in the sidebar.": "Rozpocznij poprzez wybranie przestrzeni z paska bocznego",
  "Details": "Szczególy",
  "Your current plan is ": "Twój aktualny plan to ",
  "Pressing the button below will cancel your current subscription and remove all collaborators.": "Naciśnięcie przycisku poniżej spowoduje anulowanie bieżącej subskrypcji i usunięcie wszystkich współpracowników.",
  "Cancel subscription": "Anuluj subskrybcję",
  "The starter plan is our free plan, so nothing we can cancel for you. If you are still receiving charges, let us know in our live-chat!": "Plan Startowy jest naszym bezpłatnym planem, więc nic nie możemy dla ciebie anulować. Jeśli nadal otrzymujesz opłaty, daj nam znać na naszym czacie na żywo!",
  "We are really sorry to see you go, but would love to understand why.": "Bardzo nam przykro, że odchodzisz i chcielibyśmy zrozumieć dlaczego.",
  "Set following stage after published": "Ustaw następujący etap po opublikowaniu",
  "Attention! There are ": "Uwaga! Są ",
  " reference(s). Click to show.": " referencja(i). Kliknij aby zobaczyć.",
  "Undo (Ctrl+Z)": "Cofnij (Ctrl+Z)",
  "Redo (Ctrl+Y)": "Przywróć (Ctrl+Y)",
  "This block is not available any more.": "Ten blok nie jest już dostępny.",
  "Go back to the root": "Wróć do katalogu głównego",
  "Please choose a release or create a new one to make your content changes.": "Wybierz wydanie lub utwórz nowe, aby wprowadzić zmiany w treści.",
  "First published date (asc)": "Data pierwszej publikacji (rosnąco)",
  "First published date (desc)": "Data pierwszej publikacji (malejąco)",
  "Published date (asc)": "Data publikacji (rosnąco)",
  "Published date (desc)": "Data publikacji (malejąco)",
  "Tag list": "Lista tagów",
  "First published at": "Pierwszy raz opublikowano",
  "Translated name": "Przetłumaczona nazwa",
  "You can create a new tag at the config section of a content item.": "Możesz utworzyć nowy tag w sekcji konfiguracji elementu treści.",
  "Assigned items": "Przypisane elementy",
  "User dialog": "Okno dialogowe użytkownika",
  "Containing content item": "Zawierający element treści",
  "Containing asset": "Zawierający zasób",
  "Clear all filters": "Wyczyść wszystkie filtry",
  "Load all": "Wczytaj wszystko",
  "The user dialog JSON is invalid.": "JSON okna dialogowego użytkownika jest nieprawidłowy.",
  "Edit App": "Edytuj aplikację",
  "All apps": "Wszystkie aplikacje",
  "App installed successfully!": "Aplikacja zainstalowana pomyślnie!",
  "New App": "Nowa Aplikacja",
  "App approved successfully": "Aplikacja zatwierdzona pomyślnie",
  "Your app has been submitted sucessfully.": "Twoja aplikacja została przesłana pomyślnie.",
  "Please define a name": "Proszę zdefiniować nazwę",
  "Trashcan cleared!": "Kosz wyczyszczony!",
  "Type the domain to move all users with @domain.com to the org with that domain.": "Wpisz domenę aby przenieść wszystkich użytkowników z adresem email @domena.com do organizacji z tą domeną.",
  "Define a name for the tab": "Zdefiniuj nazwę karty",
  "Are you sure you want to delete this tab?": "Czy na pewno chcesz usunąć tę kartę?",
  "Define the anchor id of the link.": "Zdefiniuj ID kotwicy łącza.",
  "is not a valid email": "nie jest poprawnym adresem email",
  "Are you sure that you want to remove this space from the organization?": "Czy na pewno chcesz usunąć tę przestrzeń z organizacji?",
  "Space has been removed from organization": "Przestrzeń została usunięta z organizacji",
  "Space added successfully": "Przestrzeń dodana pomyślnie",
  "Organization created successfully": "Organizacja utworzona pomyślnie",
  "Are you sure you want to remove this language?": "Czy na pewno chcesz usunąć ten język?",
  "Are you sure you want to unsubscribe and remove all collaborators?": "Czy na pewno chcesz anulować subskrypcję i usunąć wszystkich współpracowników?",
  "Please save the schema of this component first.": "Najpierw zapisz schemat tego komponentu.",
  "Character limit reached": "Osiągnięto limit znaków",
  "characters remaining": "znaków do wykorzystania",
  "characters over limit": "znaków ponad limit"
}
